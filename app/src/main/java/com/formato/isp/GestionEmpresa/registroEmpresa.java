...
public class registroEmpresa extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public void onErrorResponse(VolleyError error) {
        Toast.makeText(getApplicationContext(), "Asegúrese de adjuntar correctamente la imagen.", Toast.LENGTH_SHORT).show();
        p.hide();
    }
    ...
    private void pruebaRegistro() {
        ...
        VolleyMultipartRequest multipartRequest = new VolleyMultipartRequest(Request.Method.POST, url, new Response.Listener<NetworkResponse>() {
            ...
            public void onResponse(NetworkResponse response) {
                ...
                Intent intent = new Intent(getApplicationContext(), buscar_empresa.class);
            ...
            protected Map<String, String> getParams() {
                ...
                nombreempr=nombre.getText().toString();
