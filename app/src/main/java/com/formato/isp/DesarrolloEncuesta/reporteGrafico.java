...
public class reporteGrafico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            private String[] qualities = new String[]{"Técnica y productiva", "Financiera y administrativa", "Cultural, empresarial e innovación", "Recursos de inversión"};
    ...
    private void setData() {
        ...
        RadarDataSet set1 = new RadarDataSet(employe1, "Capacitación");
        ...
        RadarDataSet set2 = new RadarDataSet(employe1, "Acceso a capital");
