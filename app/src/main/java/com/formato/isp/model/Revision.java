...
public class Revision {
    ...
    public Revision(String empresa_empr_nit, String revi_id, String revi_descripcion, String revi_fechainicio, String revi_fechafinal, int revi_prioridad, boolean revi_estado,String grafica) {
